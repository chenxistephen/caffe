#ifndef CAFFE_MULTILABEL_ACCURACY_LAYER_HPP_
#define CAFFE_MULTILABEL_ACCURACY_LAYER_HPP_
...
class MultilabelAccuracyLayer : public Layer<Dtype> {
 public:
   ...
   *     with MultilabelAccuracyLayer options:
...
#endif  // CAFFE_MULTILABEL_ACCURACY_LAYER_HPP_
